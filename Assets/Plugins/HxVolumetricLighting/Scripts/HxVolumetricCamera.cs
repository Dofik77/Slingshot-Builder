...
public class HxVolumetricCamera : MonoBehaviour
{
...
#if HXVR
        if (Mycamera.stereoTargetEye == StereoTargetEyeMask.Both && Application.isPlaying && UnityEngine.XR.XRSettings.enabled)
        {
            return true;
        }
#endif
   ...
   // bool warned = false;
    ...
    {
#if HXVR
        if (Mycamera.stereoTargetEye != StereoTargetEyeMask.None && Application.isPlaying && UnityEngine.XR.XRSettings.enabled)
        {
